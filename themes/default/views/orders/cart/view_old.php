...
<!-- breadcrumbs (begin) -->
    ...
    <div class="cart3 g-clearfix">
        ...
        <ul class="cart-products">
            ...
            <?php endforeach ?>
            <?php
                echo Yii::t('OrdersModule.core','Delivery price ').$model->delivery_price*$rate."UAH";
            ?>

            <?php if(!empty($model->do_card))echo Yii::t('OrdersModule.core','Card price')." - ".$cardPrice*$rate."UAH"?>
            <?php if(!empty($model->doPhoto))echo Yii::t('OrdersModule.core','Photo price')." - ".$photoPrice*$rate."UAH"?>
